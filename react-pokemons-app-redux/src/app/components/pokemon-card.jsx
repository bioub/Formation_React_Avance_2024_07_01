...
import { idsToCompareSelector, selectPokemonId } from '../store/pokemonsSlice';
...
function PokemonCard({ pokemon }) {
  ...
  return (
    <div className={classNames("col s6 m4", {'blue': pokemonIds.includes(pokemon.id)})} onClick={() => dispatch(selectPokemonId(pokemon.id))}>
